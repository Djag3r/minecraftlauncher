...
namespace minecraftlauncher
{
    public partial class General : Form
    {
        ...
        {
            //Process.Start(@"http://thegamefunproject.ru");
            MessageBox.Show("Сайт в разработке!");
        }

        private void General_Load(object sender, EventArgs e)
        {
            remember_me.Checked = true;
            nick_box.Text = Properties.Settings.Default.textBox1;
            password_box.Text = Properties.Settings.Default.textBox2; //Загружаем наши данные
        ...
        private void General_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                Properties.Settings.Default.textBox1 = nick_box.Text;
                Properties.Settings.Default.textBox2 = password_box.Text;
